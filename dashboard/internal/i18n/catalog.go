...
// Current is the active catalog. This fork is US/English-only: upstream
// career-ops supports switching to Tr/Es catalogs via a "t" keybinding and a
// --lang flag, both removed here — Current is always &En.
var Current = &En
