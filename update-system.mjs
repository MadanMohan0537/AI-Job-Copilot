...
const SYSTEM_PATHS = [
  ...
  'ARCHITECTURE.md',
  'README.md',
  // Non-English README translations removed in this US-only fork
  // (README.ar.md, .cn.md, .da.md, .de.md, .es.md, .fr.md, .hi.md, .ja.md,
  // .ko-KR.md, .pl.md, .pt-BR.md, .ru.md, .ta.md, .ua.md, .zh-TW.md, .tr.md).
  'CHANGELOG.md',
  'CODE_OF_CONDUCT.md',
  'CONTRIBUTORS.md',
  '.all-contributorsrc',
